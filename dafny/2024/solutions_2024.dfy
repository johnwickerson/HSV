...
//
// Note: there is another file called solutions_2024_extended.dfy, which is
// similar, but proves a stronger (and more intellectually satisfying!)
// postcondition for naive_solve.
